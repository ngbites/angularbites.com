...
This can accelerate the understanding of a codebasem reduce confusion, and deepen the insights gathered from just reading the types of your code.
...
- you don't know the format of `lastEdited`. Is it a Unix timestamp, or a Julian day? Or the aount of days since Earth was created? Who knows.
